...
\feast{APTP}{Commune Apostolorum\\et Evangelistarum\\Tempore Paschali}
	...
	{}
	{}
\rubric{Sub una Antiphona in quolibet Nocturno dicuntur Psalmi ut supra extra Tempus Paschale, pag.\ \pageref{M-CommuneApostolorumExtraTempusPaschale}.  Lectiones trium Nocturnorum, ut extra Tempus Paschale, cum Responsoriis sequentibus.}
...
\gscore{APTPN1R1}{R}{1}{Beatus vir qui metuit Dominum V Gloria et divitiae}
\gscore{APTPN1R2}{R}{2}{Tristitia vestra V Mundus quidem gaudebit}
\gscore{APTPN1R3}{R}{3}{Pretiosa in conspectu V Custodit dominus omnia V Gloria}
\nocturn{1}
...
\gscore{APTPN2R1}{R}{4}{Lux perpetua lucebit Sanctis tuis V Laetitia sempiterna}
\gscore{APTPN2R2}{R}{5}{Virtute magna reddebant V Repleti quidem Spiritu}
...
\gscore{APTPN2R3}{R}{6}{Isti sunt agni novelli V In conspectu Agni V Gloria}
\nocturn{1}
...
\gscore{APTPN3R1}{R}{7}{Ego sum vitis vera V Sicut dilexit me}
...
\gscore{APTPN3R2}{R}{8}{Candidi facti sunt Nazaraei V Candidiores nive V Gloria}
\tedeumrubric
