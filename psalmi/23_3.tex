...
\item Innocens mánibus et mundo corde,~\pscross{} qui non accépit in vano \textbf{á}nimam \textbf{su}am,~\psstar{} nec jurávit in dolo \textbf{pró}ximo \textbf{su}o.
...
\item Attóllite portas, príncipes, vestras,~\pscross{} et elevámini, portæ \textbf{æ}ter\textbf{ná}les:~\psstar{} et intro\textbf{í}bit Rex \textbf{gló}riæ.
\item Quis est iste Rex glóriæ?~\pscross{} Dóminus \textbf{for}tis et \textbf{pot}ens:~\psstar{} Dóminus \textbf{pot}ens in \textbf{prǽ}lio.
\item Attóllite portas, príncipes, vestras,~\pscross{} et elevámini, portæ \textbf{æ}ter\textbf{ná}les:~\psstar{} et intro\textbf{í}bit Rex \textbf{gló}riæ.
