...
\item Tu humiliásti sicut vulnerá\-tum, \textit{su}\textbf{pér}bum:~* in bráchio virtútis tuæ dispersísti ini\textit{mí}\textit{cos} \textbf{tu}os.
...
\item Si justítias meas pro\textit{fa}\textbf{ná}ve\-rint:~* et mandáta mea non \textit{cus}\textit{to}\textbf{dí}erint:
