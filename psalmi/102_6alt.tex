...
\item Quómodo miserétur pater filiórum,~\pscross{} misértus est Dóminus timén\textit{ti}\textbf{bus} se:~\psstar{} quóniam ipse cognóvit fig\textit{méntum} \textbf{nos}trum.
\item Recordátus est quóniam pulvis sumus:~\pscross{} homo, sicut fœnum di\textit{es} \textbf{e}jus,~\psstar{} tamquam flos agri sic \textit{efflo}\textbf{ré}bit.
...
\item Benedícite Dómino omnes Angeli ejus:~\pscross{} poténtes virtúte, faciéntes verbum \textit{il}\textbf{lí}us,~\psstar{} ad audiéndam vocem ser\textit{mónum} \textbf{e}jus.
\item Benedícite Dómino omnes Virtú\textit{tes} \textbf{e}jus:~\psstar{} minístri ejus, qui fácitis volun\textit{tátem} \textbf{e}jus.
\item Benedícite Dómino ómnia ópera ejus:~\pscross{} in omni loco dominatió\textit{nis} \textbf{e}jus,~\psstar{} bénedic ánima \textit{mea} \textbf{Dó}mino.
